...
#######################
## get_features_3lb_all_ord: jk paper에 사용한 feature
#######################
...
#######################
## 교수님 get_features_3lb_all_ord_rr 코드에 feature 추출 방법만 변경한 코드
#######################

def get_features_3lb_all_ord_rr1(data_folder, patient_files_trn, po = .3,
                          samp_sec=20, pre_emphasis = 0, hop_length=256, win_length = 512, n_mels = 100,
                             filter_scale = 1, n_bins = 80, fmin = 10, trim = 4000,
                                use_mel = True, use_cqt = False, use_stft = False, 
                                per_sec = 4000, use_raw = False, use_rr = False
                         ) :
    features = dict()
    features['id'] = []
    features['age'] = []
