...
def run_challenge_model(model, data, recordings, verbose):
    ...
    if model['model1'] == 'c1' :
        model1 = get_LCNN_interval_only_conv(model['mel_shape'],model['cqt_shape'],model['stft_shape'], model['interval_shape'],
                                    
                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                    use_stft = model['use_stft'],
                                    ord1 = model['ord1'], dp = model['dp'], fc = model['fc'], 
                                    ext = model['ext'])  
    if model['model2'] == 'c1_o' :
        model2 = get_LCNN_interval_only_conv_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
    ...
    if model['model1'] == 'd2' :
        model1 = get_LCNN_interval_only_dilated2(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'],
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],
                                            ord1 = model['ord1'], dp = model['dp'], fc = model['fc'], 
    ...
    if model['model2'] == 'd2_o' :
        model2 = get_LCNN_interval_only_dilated2_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
    ...
    if model['model1'] == 'd3' :
        model1 = get_LCNN_interval_only_dilated3(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd3_o' :
        model2 = get_LCNN_interval_only_dilated3_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd4' :
        model1 = get_LCNN_interval_only_dilated4(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
        
    if model['model2'] == 'd4_o' :
        model2 = get_LCNN_interval_only_dilated4_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd5' :
        model1 = get_LCNN_interval_only_dilated5(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd5_o' :
        model2 = get_LCNN_interval_only_dilated5_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd6' :
        model1 = get_LCNN_interval_only_dilated6(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
        
    if model['model2'] == 'd6_o' :
        model2 = get_LCNN_interval_only_dilated6_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd7' :
        model1 = get_LCNN_interval_only_dilated7(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd7_o' :
        model2 = get_LCNN_interval_only_dilated7_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])      
    ...
    if model['model1'] == 'd8' :
        model1 = get_LCNN_interval_only_dilated8(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
        
    if model['model2'] == 'd8_o' :
        model2 = get_LCNN_interval_only_dilated8_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd9' :
        model1 = get_LCNN_interval_only_dilated9(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd9_o' :
        model2 = get_LCNN_interval_only_dilated9_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])   
    ...
    if model['model1'] == 'd10' :
        model1 = get_LCNN_interval_only_dilated10(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd10_o' :
        model2 = get_LCNN_interval_only_dilated10_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd11' :
        model1 = get_LCNN_interval_only_dilated11(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd11_o' :
        model2 = get_LCNN_interval_only_dilated11_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])      
    ...
    if model['model1'] == 'd12' :
         model1 = get_LCNN_interval_only_dilated12(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
        
    if model['model2'] == 'd12_o' :
        model2 = get_LCNN_interval_only_dilated12_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                            model['interval_shape'], 
                                            use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                            use_stft = model['use_stft'],ord1 = model['ord1'], 
                                            dp = model['dp'], fc = model['fc'], ext = model['ext'])
    ...
    if model['model1'] == 'd13' :
        model1 = get_LCNN_interval_only_dilated13(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd13_o' :
        model2 = get_LCNN_interval_only_dilated13_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])   
    ...
    if model['model1'] == 'd14' :
        model1 = get_LCNN_interval_only_dilated14(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                model['interval_shape'],
                                                use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                use_stft = model['use_stft'], ord1 = model['ord1'], 
                                                dp = model['dp'], fc = model['fc'], ext = model['ext'])  
        
    if model['model2'] == 'd14_o' :
        model2 = get_LCNN_interval_only_dilated14_o(model['mel_shape'],model['cqt_shape'],model['stft_shape'], 
                                                    model['interval_shape'],
                                                    use_mel = model['use_mel'],use_cqt = model['use_cqt'], 
                                                    use_stft = model['use_stft'],ord1 = model['ord1'], 
                                                    dp = model['dp'], fc = model['fc'], ext = model['ext'])               
...
#             amplit_smooth = smoothing(amplitude_envelope, smooth)

#             # threshld selection
#             mu = np.sum(amplit_smooth)/len(amplit_smooth)
#             var = np.sum((amplit_smooth-mu)**2)/len(amplit_smooth)
#             t_sh = mu + var +0.05

#             thres_list = np.argwhere(amplit_smooth > t_sh)
#             save = []
#             for i in thres_list:
#                 j = i[0]
#                 save.append(j)
...
#     features['envel_mel'] = np.array(features['envel_mel'])
    ...
    res1 = model1.predict([features['age'], features['sex'], features['hw'], features['preg'],
                            features['loc'], features['interval'],features['mel1'], features['stft1'], 
                            features['cqt1']])
    ...
    if murmur_probabilities[0] > 0.496 : # 0.482 (jk)
        idx = 0
    else :
        idx = 2
#    idx = np.argmax(murmur_probabilities)
    ...
    if outcome_probabilities[0] > 0.617 : # 0.607 (jk)
        idx = 0
    else :
        idx = 1
...
## c1 모델 돌리기 : pi_s conv 모델

###################### lcnn_dr random search

# model_select = np.array((['d1','d1_o'],['d2','d2_o'],['d3','d3_o'],['d4','d4_o'],
#                 ['d5','d5_o'],['d6','d6_o'],['d7','d7_o']
#                 ))
model_select = np.array((['c1','c1_o'],['d8','d8_o']
                ))
# for i in range(len(model_select)):
for i in range(1):
    m1, m2 = model_select[i]
    for j in range(5) :
        model_folder = 'lcnn_dilated'
        output_folder = '/Data/jk_paper/JK_paper/out_lcnn_dilated'
        ...
        hoplen = 256
        # 값 변경: 특징추출때부터 반영필요
        nmel = 120 # 140(sy) #np.random.choice([100, 120, 140]) 
        nsec = 20 # 50(sy)
        trim = 1 # 0(sy); #np.random.choice([0,2000, 4000])
        use_mel = True
        ...
        # model_select  = 6
        # m1,m2=np.array((['lcnn7','lcnn8'],['lcnn9','lcnn10'],['lcnn11','lcnn12'],['lcnn13','lcnn14'],
        #             ['lcnn15','lcnn16'],['lcnn17','lcnn18'],['lcnn19','lcnn20']
        #             ))[model_select]
        ...
        if m1 =='c1':
            model1=get_LCNN_interval_only_conv(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='c1_o':
            model2=get_LCNN_interval_only_conv_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)    
        
        if m1 =='c2':
            model1=get_LCNN_interval_conv(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,interval_mean_input_shape, use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='c2_o':
            model2=get_LCNN_interval_conv_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,interval_mean_input_shape, use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)        

        if m1 =='d3':
            model1=get_LCNN_interval_only_dilated3(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='d3_o':
            model2=get_LCNN_interval_only_dilated3_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)    
        
        if m1 =='d4':
            model1=get_LCNN_interval_only_dilated4(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='d4_o':
            model2=get_LCNN_interval_only_dilated4_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)        


        if m1 =='d5':
            model1=get_LCNN_interval_only_dilated5(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='d5_o':
            model2=get_LCNN_interval_only_dilated5_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)    
        
        if m1 =='d6':
            model1=get_LCNN_interval_only_dilated6(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='d6_o':
            model2=get_LCNN_interval_only_dilated6_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)        

        if m1 =='d7':
            model1=get_LCNN_interval_only_dilated7(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)
        if m2 =='d7_o':
            model2=get_LCNN_interval_only_dilated7_o(mel_input_shape, cqt_input_shape, stft_input_shape,interval_input_shape,use_mel = use_mel, ord1 = ord1,dp = dp, fc = fc, ext = ext)        
        ...
        if mixup :
            ...
            model1.fit(TrainDGen_1,
                    ...
                    epochs = n_epoch)
            end_time = time.time()
            training_time_murmur = end_time - start_time
            print(f"training time_murmur: {training_time_murmur:.2f} sec")
    ...
    #              'ranfilter2' : [3, [18,19,20,21,22,23]]
        ...
        if mixup :
            ...
            end_time = time.time()
            training_time_outcome = end_time - start_time
            print(f"training time_outcome: {training_time_outcome:.2f} sec")
        ...
        save_challenge_model(model_folder, model1, model2, m_name1 = m1, m_name2 = m2, 
                            param_feature = params_feature)
        ...
        print(f"evaluation time: {evaluation_time:.2f} sec")
        ...
        for th1 in range(1, 100) : #  [0.01, 0.05, 0.1, 0.15,0.2, 0.25, 0.3, 0.32, 0.35, 0.38, 0.4, 0.42, 0.45, 0.47, 0.5, 0.52, 0.55, 0.57, 0.6, 0.62, 0.65, 0.7, 0.75, 0.8] :
            ...
            if murmur_weighted_accuracy > max_wc :
                ...
                max_th = th1
                max_auroc = murmur_auroc
                max_auprc = murmur_auprc
                max_f_measure = murmur_f_measure
                max_acc = murmur_accuracy
            ...
            if outcome_cost < min_cost :
                ...
                min_th = th1
                min_auroc = outcome_auroc
                min_auprc = outcome_auprc
                min_f_measure = outcome_f_measure
                min_acc = outcome_accuracy

        params_feature['training_time_murmur'] = training_time_murmur 
        params_feature['training_time_outcome'] = training_time_outcome
        params_feature['evaluation_time'] = evaluation_time
        params_feature['max_wc'] = max_wc
        params_feature['max_th'] = max_th
        params_feature['murmur_auroc'] = max_auroc
        params_feature['murmur_auprc'] = max_auprc
        params_feature['murmur_f_measure']=max_f_measure
        params_feature['murmur_accuracy']=max_acc

        params_feature['min_cost'] = min_cost
        params_feature['min_th'] = min_th
        params_feature['outcome_auroc'] = min_auroc
        params_feature['outcome_auprc'] = min_auprc
        params_feature['outcome_f_measure']=min_f_measure
        params_feature['outcome_accuracy']=min_acc

        tnow = datetime.datetime.now()
        result_folder= 'res_interval_only_conv'
        os.makedirs(result_folder, exist_ok=True)
        
        fnm = 'res_interval_only_conv/rec'+ str(tnow)+'.pk'
